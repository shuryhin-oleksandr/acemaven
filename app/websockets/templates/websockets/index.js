...
let myMessageRender = (messages) => {
        ...
        messages.forEach(m => {
                ...
                <img width="40" height="40" src=${m.photo ? m.photo : "{% static 'websockets/icons/defaultUserPhoto.svg' %}"} alt="" class='userPhoto'>
            </div>
            ${m.content 
                ...
                : `<div class="myFileMessageContent">
                        <a class="iconWrapper" href=${m.files[0]} target='_blank'>
                            <img src="{% static 'websockets/icons/upload-file-svgrepo-com.svg' %}" alt="">
                        </a>
            ...
            <div class="localTimeWrapper" style="margin-right: 25px;">
                ...
                <div class="deleteMessageWrap" id=${m.id}>
                    <img width="15" height="15" src="{% static 'websockets/icons/delete_gray.svg' %}" alt="" class="deleteMessageWrapImg">
                </div>
            </div>`
            ...
            oppponentMessageWrapper.innerHTML = ` <div class="opponentPhotoWrapper">
                <img src=${m.photo ? m.photo : "{% static 'websockets/icons/defaultUserPhoto.svg' %}"} alt="" class='userPhoto'>
            </div>
            ${m.content 
...
let newMessageRender = (message) => {
        ...
        if (message.user_id === my_id) {
            ...
            myMessageWrapper.innerHTML = ` <div class="myPhotoWrapper">
                <img width="40" height="40" src=${message.photo ? message.photo : "{% static 'websockets/icons/defaultUserPhoto.svg' %}"} alt="" class='userPhoto'>
            </div>
            ${message.content 
                ?  `<div class="myTextContent">
                        ${message.content}
        ...
        opponentMessageWrapper.innerHTML = ` <div class="opponentPhotoWrapper">
                <img src=${message.photo ? message.photo : "{% static 'websockets/icons/defaultUserPhoto.svg' %}"} alt="" class='userPhoto'>
            </div>
            ${message.content 
                ? `<div class="opponentTextContent">
                        ${message.content}
    ...
    if (res.user_id !== my_id) {
        ...
        opponentMessageWrapper.innerHTML = `
            <div class="typingPhotoWrapper">
                    <img src=${res.photo ? res.photo:"{% static 'websockets/icons/defaultUserPhoto.svg' %}" } alt="" class='userPhoto'>
                </div>
                <div class="typingIconWrapper">
                    <img src="{% static 'websockets/icons/giphy.gif' %}" alt="">
                </div>
               `
